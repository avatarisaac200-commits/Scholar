...
export const EXAM_TEMPLATES: ExamTemplate[] = [
  {
    ...
    officialStructureNote: 'JAMB UTME uses 180 MCQs: Use of English 60, three other subjects 40 each, in one 120-minute CBT session.',
    sections: [
  ...
  },
  {
    ...
    officialStructureNote: 'This preserves the existing OAU Prep flow rather than imposing a new official exam structure.',
    sections: [
  ...
  },
  {
    ...
    description: 'Flexible OAU P-UTME template: English, selected UTME subjects, and aptitude/general reasoning can be adjusted by admin.',
    durationMinutes: 60,
    structureSource: 'admin-configured',
    officialStructureNote: 'OAU has not officially published exact P-UTME question counts or timing, so this template is intentionally editable.',
    sections: [
